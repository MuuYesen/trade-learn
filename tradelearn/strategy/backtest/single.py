...
class LongBacktest:
    ...
    def run(test_data, base_line, model_dict, feature_list, select_func, weight_func):
        ...
        re_col = ['open', 'high', 'low', 'close', 'volume'] + test_data.columns.drop(
            ['open', 'high', 'low', 'close', 'volume']).tolist()
        ...
        cerebro.addstrategy(Long, model_dict=model_dict, feature_list=feature_list, select_func=select_func,
