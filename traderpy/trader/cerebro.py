...
from .plot import BacktraderPlotting
...
class Cerebro(with_metaclass(MetaParams, object)):
    ...
    def plot(self, plotter=None, numfigs=1, iplot=False, start=None, end=None, use=None, output_mode='save', filename=None, show_source=True, **kwargs):  # modify
        '''
        ...
        if plotter is None:
            from traderpy.trader.plot.schemes import Scheme, Blackly, Tradimo
            plotter = BacktraderPlotting(scheme=Blackly(**kwargs), output_mode=output_mode, filename=filename, show_source=show_source)
